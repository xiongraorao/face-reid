...
if __name__ == "__main__":
    ...
    r = requests.post("http://192.168.1.6:9000/search/all",data=json.dumps(data_request), headers=headers)
    print(r.text)
    ...
    zk.start()
    #zk.ensure_path("/router/192.168.1.6:8000")
    #zk.delete("/router/192.168.1.6:8000")
