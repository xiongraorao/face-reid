...
# char *input_filename, bool nobuffer, bool use_gpu
ffmpegPython.init.argtypes = [c_char_p, c_bool, c_bool]
ffmpegPython.init.restype = c_int
initErr = ffmpegPython.init(rtspUrl.encode("utf8"), True, False)
print(initErr)
# initErr:
#       0:      success
